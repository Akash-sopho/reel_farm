...
| P1-T13 | Implement Render Pipeline | Dev | P1-T12, P1-T10, P1-T08 | ⏳ PENDING |
| P1-T14 | Render Download Endpoint | Dev | P1-T13 | ⏳ PENDING |
| P1-T15 | Frontend — Template Gallery Page | Dev | P1-T02, P0-T05 | ⏳ PENDING |
| P1-T16 | Frontend — Editor Page (Slot Filler) | Dev | P1-T08, P1-T06, P1-T15 | ⏳ PENDING |
...
| ID | Title | Role | Depends | Status |
|---|---|---|---|---|
| P1.5-T01 | Spec — Video Intake API | Planner | P0-T03 | ⏳ PENDING |
| P1.5-T02 | Implement yt-dlp Video Fetcher Service | Dev | P1.5-T01 | ⏳ PENDING |
