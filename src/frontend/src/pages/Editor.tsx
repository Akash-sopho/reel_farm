...
export const Editor: React.FC = () => {
  ...
  // Get first image slot for preview
  const firstImageSlot = sceneSlots.find((s: any) => s.type === 'image');
  const firstImageFill = firstImageSlot
    ? project.slotFills.find((f) => f.slotId === firstImageSlot.id)
    : null;
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex h-[calc(100vh-100px)]">
        ...
        <div className="flex-1 bg-gray-50 p-8 flex items-center justify-center">
          {firstImageFill && firstImageFill.value ? (
            <img
              src={firstImageFill.value}
              alt="Preview"
              className="max-w-full max-h-full object-contain rounded-lg shadow-lg"
            />
          ) : (
            <div className="w-64 h-96 bg-gradient-to-br from-gray-300 to-gray-400 rounded-lg shadow-lg flex items-center justify-center">
              <div className="text-center">
                <svg
                ...
                <p className="text-gray-600 font-semibold">Upload an image</p>
              </div>
            </div>
          )}
        </div>
